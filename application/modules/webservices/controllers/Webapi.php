...
// die;
        ...
        if (isPostBack()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($apikey == APIKEY) {
                    ...
                    $getdata = $this->Webapi_model->notification_list();
                //    pr($getdata); die;
                if(count($getdata) < 1){
                    $getdata = [];
                } 
    ...
    public function undone_weekly_post() {
        $apikey = $this->input->post('apikey');
        $id = $this->input->post('id');
        ...
        if (isPostBack()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($apikey == APIKEY) {
                    ...
                    $getdata = $this->Webapi_model->weekly_status_update();
                //    pr($getdata); die;
                if(count($getdata) < 1){
                    $getdata = [];
                } 
    ...
    public function get_weekly_stats_post() {
        $apikey = $this->input->post('apikey');
        $id = $this->input->post('id');
        ...
        if (isPostBack()) {
            ...
            if ($this->form_validation->run()) {
                ...
                if ($apikey == APIKEY) {
                    ...
                    $getdata = $this->Webapi_model->get_weekly_stats();
                //    pr($getdata); die;
                if(count($getdata) < 1){
                    $getdata = [];
                } 
