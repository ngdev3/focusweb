                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited" name="role" id="role">
                                        <option value="">Select Type of Manager</option>
                                  ...
                                  <?php } ?>
                                    ...
                                    <label for="role"> Type of Manager<span class="red_sign">*</span></label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited" name="location_id" id="location_id">
                                        <option value="">Select Location</option>
                                  <?php foreach(@$location as $value){ ?>
                                  <option value="<?php echo $value->id; ?>" <?php echo set_select('location_id', $value->id, $value->id == @$res->location_id ? TRUE : FALSE); ?> ><?php echo $value->location_name; ?></option>
                                  <?php } ?>
                                    </select>
                                    <div class="text-danger"><?php echo form_error("location_id"); ?></div>

                                    <label for="location_id">Location<span class="red_sign">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12 text-center">
                            <div class="form-actions noborder">
                                ...
                                <a href="<?php echo base_url("manager/list_items"); ?>"class="btn default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        messages:
                                {
                                    ...
                                    status:
                                            ...
                                            role:
                                            {
                                                required: "Please Select Manager Type!"
                                            },
