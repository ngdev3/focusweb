                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="btn-group btn_grp_list">
                                                        <a href='<?php echo base_url("masters/otp/add"); ?>' id="sample_editable_1_new" class="btn sbold green"> Add New
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
          ...
          "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]], // change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>masters/otp/list_items_ajax?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
              ...
              if(r==true)
                {
                    ...
                    $.ajax({
                        ...
                        url:"<?php echo base_url('masters/otp/delete'); ?>",
                        type:"POST",
                        datatype:"JSON",
                        data:{id:id},
                        success:function(){
                            //table.draw();
                            window.location.href="<?php echo base_url('masters/otp/list_items'); ?>";
                        },
                        error:function(){
  ...
  if(all_id.length>=1){
	...
	if(s==true)
             ...
             $.ajax({
                    ...
                    type:"POST",
                    url:"<?php echo base_url("masters/otp/delete_multiple") ?>",
                    data:{ids:all_id},
	                success:function(data){
                           window.location.href = "<?= base_url() ?>masters/otp/list_items";
                      },
                    error:function(){
                            alert("Row was not deleted");
                        }
