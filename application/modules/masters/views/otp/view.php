            ...
            <div class="portlet-body form add_prodcut_form">
                ...
                <form class="form-horizontal" role="form">
                    <div class="form-group col-md-12 col-sm-12">
                        <label for="inputEmail12" class="col-md-3 control-label">OTP : </label>
                        <div class="col-md-9">
                            <div class="input-icon" >
                                <p><?php echo ucwords($res->otp); ?></p>                          
                            </div>
                        </div>
                    </div>
                   <!--  <div class="form-group col-md-12 col-sm-12">
                        <label for="inputEmail12" class="col-md-3 control-label">OTP Used ?  </label>
                        <div class="col-md-9">
                            <div class="input-icon">
                                <p><?php
                                    if ($res->is_used == 1) {
                                        echo '<label style="color:blue;">Yes</label>';
                                    } else {
                    ...
                    <div class="form-group text-center col-xs-12 mt-15">
                        <div class="col-md-12">
                            <a href="<?php echo base_url("masters/otp/list_items"); ?>"class="btn green">Back</a>
                        </div>
                    </div>
                </form>
