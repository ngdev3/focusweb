<!-- <a  href="<?php echo base_url('masters/area/view/'.  ID_encode($data->id)); ?>" data-toggle="tooltip" class="tooltips" title="View"> <i class="fa fa-eye"></i> </a> &nbsp;
<a href="<?php echo base_url('masters/area/edit/'.  ID_encode($data->id)); ?>" data-toggle="tooltip" class="tooltips" title="Edit"> <i class="fa fa-edit"></i> </a> &nbsp; 
...
<!-- <a href="<?php echo base_url("role/assign_permission/$id/user"); ?>" data-toggle="tooltip" class="tooltips" title="Assign Permission"> <i class="fa fa fa-cog"></i> </a> -->
  ...
  <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                 <li>
                                                                    <a href="<?php echo base_url('masters/location/view/'.  ID_encode($data->id)); ?>">
                                                                        <i class="fa fa-eye" aria-hidden="true"></i> View </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo base_url('masters/location/edit/'.  ID_encode($data->id)); ?>">
