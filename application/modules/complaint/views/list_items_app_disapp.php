                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column"   id="location-grid">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Date of<br> Activity<br> Marked</th>
                                                    <th>Status</th>
                                                    <th>Continued/<br>Rescheduled<br>Date</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                          </table>
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
           ...
           "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]], // change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>complaint/list_items_ajax_app_disapp/<?php echo $this->uri->segment(3);?>?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
              ...
              if(r==true)
                {
                    $.ajax({
                        ...
                        success:function(){
                            //table.draw();
                            window.location.href="<?php echo base_url('complaint/list_items_app_disapp'); ?>";
                        },
                        error:function(){
	...
	if(s==true)
             ...
             $.ajax({
	                ...
	                success:function(data){
                           window.location.href = "<?= base_url() ?>complaint/list_items";
                      }
            });
		}
	  }); 
