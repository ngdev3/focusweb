<style>
    ...
    .form-horizontal .control-label{text-align:left!important;font-weight:600;}
                    ...
                    <?php     if(getUserInfos()->role == "3"){ ?>     
                        ...
                        <label for="inputEmail12" class="col-md-2 control-label bold">Sales person :</label>
                        <div class="col-md-2">
                            <div class="input-icon" >
                                <p><?php echo  ucwords($res->fname. ' '.$res->lname); ?></p>                          
                            </div>
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
           ...
           "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]], // change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>salespersonactivity/list_items_ajax_activity/<?php echo $this->uri->segment(3);?>?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
