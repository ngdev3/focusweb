						...
						<div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="table-toolbar">
                                         ...
                                         <a href='<?php echo base_url("manage_service_order/add"); ?>' id="sample_editable_1_new" class="btn sbold green pull-right">Create Order
                                    </a>
                                        <br><br> <br>          
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
           ...
           "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]], // change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>manage_service_order/list_items_ajax?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
    ...
    $(document).ready(function() {
        ...
        jConfirm('Are you sure?', 'Confirmation Dialog', function(r) {
              ...
              if(r==true)
                {
                    $.ajax({
                        url:"<?php echo base_url('manage_service_order/delete'); ?>",
                        type:"POST",
                        data:{id:id},
                        success:function(){
                            //table.draw();
                            window.location.href="<?php echo base_url('manage_service_order/list_items'); ?>";
                        },
                        error:function(){
