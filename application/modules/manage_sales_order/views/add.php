                ...
                <form role="form" id="add_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                         ...
                         <?php  if ( getUserInfos()->role == "0") {?>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited get_sales_person_id get_client" name="manager_id" id="manager_id">
                         ...
                         <?php   } ?>
                             ...
                             <?php if(getUserInfos()->role == "0"){ ?>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited get_sales_person_id get_client" name="cordinator_id" id="cordinator_id">
                            ...
                            <!--Coordinator--->
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited get_client" name="sales_person_id"  id="sales_person_id">
                                        <option value="">Select Sales Person</option>
                                  <?php foreach(@$sales_person as $value){ ?>
                                  <option value="<?php echo $value->id; ?>" <?php echo set_select('sales_person_id', $value->id, $value->id == @$res->sales_person_id ? TRUE : FALSE); ?> ><?php echo $value->fname.' '.$value->lname; ?></option>
                                  <?php } ?>
                                    </select>
                                    <div class="text-danger error_sales_person_id"><?php echo form_error("sales_person_id"); ?></div>

                                    <label for="sales_person_id">Select Sales Person<span class="red_sign">*</span></label>
                            ...
                            <?php } ?>
                                ...
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited get_client" name="sales_person_id"  id="sales_person_id">
                                        <option value="">Select Sales Person</option>
                                  <?php foreach(@$static_salesperson as $value){ ?>
                                  <option value="<?php echo $value->id; ?>" <?php echo set_select('sales_person_id', $value->id, $value->id == @$res->sales_person_id ? TRUE : FALSE); ?> ><?php echo $value->fname.' '.$value->lname; ?></option>
                                  <?php } ?>
                                    </select>
                                    <div class="text-danger error_sales_person_id"><?php echo form_error("sales_person_id"); ?></div>
                    ...
                    <div class="box">
                       ...
                       <div class="col-md-offset-1 col-md-10">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <select class="form-control edited get_product_details get_product_rate get_product_kva_hp" name="product_id"  id="product_id">
                       ...
                       <div class="col-md-offset-1 col-md-10" id="kva_id">
                            <div class="form-group form-md-line-input form-md-floating-label">
                            <select class="form-control"  id="kva" name="kva" >
                                
                                    </select>
                               <!--  <input type="text" class="form-control numOnly" readonly id="kva" name="kva"  value="<?php echo set_value("kva", @$res->kva); ?>"> -->
                                    <div class="text-danger error_kva"><?php echo form_error("kva"); ?></div>
                       ...
                       <center id="or_id"><h4>OR</h4></center>
                                <div class="form-group form-md-line-input form-md-floating-label">
                                <input type="text" class="form-control numOnly" id="hp" readonly name="hp"  value="<?php echo set_value("hp", @$res->hp); ?>">
                                    <div class="text-danger error_hp"><?php echo form_error("hp"); ?></div>
                       ...
                       <div class="col-md-offset-1 col-md-10">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                <input type="text" class="form-control numOnly" id="price" name="price" readonly value="<?php echo set_value("price", @$res->price); ?>">
                    ...
                    <div class="input_fields_wrap"></div>
                             ...
                             <!--Basic Ordered Value--->
                               ...
                               <!--Basic Ordered Value--->
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" autocomplete="off" class="form-control numOnly" id="gst" name="gst"  value="<?php echo set_value("gst", @$res->gst); ?>">
                                    <div class="text-danger error_gst"><?php echo form_error("gst"); ?></div>

                                    <label for="gst">GST(%)<span class="red_sign">*</span></label>
                                </div>
                              </div>
                            ...
                            <!--Term of Payment--->
                              ...
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <div class="text-danger"><?php echo form_error("payment_description"); ?></div>

                                    <label for="payment_description error_payment_description">Payment Description</label>
                                </div>
                              </div>
                            <!--Payment Description--->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12 text-center">
                            <div class="form-actions noborder">
                                ...
                                <a href="<?php echo base_url("manage_sales_order/list_items"); ?>"class="btn default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
                $(document).on('change', '.get_sales_person_id', function() {
                   var manager_id=$("#manager_id").val();
   ...
   // alert("sdf");
        ...
        var total =price*quantity;
            ...
            $.ajax({
             ...
             if((product_id!="" && quantity!="" && unit_id!="" && kva!="" && price!="") || (product_id!="" && quantity!="" && unit_id!="" && hp!="" && price!="")   ){
               ...
               $.ajax({
                    ...
                    success: function(data) {
                        if(data==true){
                            ...
                            $(wrapper).append('<div style="margin:80px;" id="remove_'+x+'"><span><i class="fa fa-circle"></i></span>&nbsp;<label><b>Product: </label></b>' +'&nbsp;&nbsp;<p1>'+product_id_name+'</p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Capacity (HP) :</b></label>' +'&nbsp;&nbsp;<p1>'+hp+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Qty :</b></label>' +'&nbsp;&nbsp;<p1>'+quantity+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Unit:</b></label>' +'&nbsp;&nbsp;<p1>'+unit_id+' </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Price(INR) :</b></label>' +'&nbsp;&nbsp;<p1>'+price+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Total(INR) :</b></label>' +'&nbsp;&nbsp;<p1>'+total+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+input_apeends+'</div>'); //add input box
                            $("#product_id").val(""); 
                            $("#hp").val(""); 
                            $("#quantity").val("");
                            $("#unit_id").val("");
                            $("#price").val("");
                                ...
                                $(wrapper).append('<div style="margin:80px;" id="remove_'+x+'"><span><i class="fa fa-circle"></i></span>&nbsp;<label><b>Product: </label></b>' +'&nbsp;&nbsp;<p1>'+product_id_name+'</p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Capacity (KVA) :</b></label>' +'&nbsp;&nbsp;<p1>'+kva+' </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Qty :</b></label>' +'&nbsp;&nbsp;<p1>'+quantity+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Unit:</b></label>' +'&nbsp;&nbsp;<p1>'+unit_id+' </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Price(INR) :</b></label>' +'&nbsp;&nbsp;<p1>'+price+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+'<label ><b>Total(INR) :</b></label>' +'&nbsp;&nbsp;<p1>'+total+'  </p1>&nbsp;&nbsp;&nbsp;&nbsp;'+input_apeends+'</div>'); //add input box
                                $("#product_id").val(""); 
                                $("#kva").val("");
                                $("#quantity").val("");
                                $("#unit_id").val("");
...
//alert("ayaaa");
                ...
                var field3 = $("#sales_person_id").val(); 
           ...
           var z = false;
		    ...
		    if(field1==""){
               ...
               if(field3==""){
				    z = true;
				   $(".error_sales_person_id").text("Please Select Sales Person!");
			   }else{
                $(".error_sales_person_id").text("");
 ...
 */               if(field9==""){
               ...
               if(field10==""){
				    z = true;
				   $(".error_gst").text("Please Enter GST(%)!");
			   }else if(field10<="0"){
                $(".error_gst").text("The GST(%) field must contain a number greater than  0.");
               }else{
                $(".error_gst").text("");
