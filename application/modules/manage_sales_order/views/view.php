        ...
        <div class="portlet-title">
            ...
            <?php @$newDate = date("d-m-Y", strtotime($res->created_date)); 
                ...
                <div class="form-group col-md-12 col-sm-12">
                        <label for="inputEmail12" class="col-md-3 control-label"><b>Sales Person :</b></label>
                        <div class="col-md-9">
                    ...
                    <table class="table1 table-striped table-bordered table-hover box" >
                        ...
                        <th id="line"> <center>Products </center></th>
                        <th id="line"> <center>Capacity (KVA) </center></th>
                        <th id="line"> <center>Capacity (HP) </center></th>
                        ...
                        <th id="line"> <center>Total Orderd value</th></center>
                         ...
                         <tr>
                                ...
                                <td id="line"  scope="col"> <center><?php if($row->kva==""){echo"-";}else{ echo $row->kva; } ?></center></td>

                                <td id="line"  scope="col"> <center><?php if($row->hp==""){echo"-";}else{ echo $row->hp; } ?></center></td>
                       ...
                       /*  pr($a);
                        pr($detail); */
                       // $total=($total_amount*$quantity)+$gst;
                       foreach (@$detail as $i => $row){
                                $a=($row->total);
                                $a=$a+$a*($row->gst/100);
                                $b=$a+$b;
                ...
                <br><br>
                    ...
                    <div class="form-group col-md-12 col-sm-12">
                     ...
                     <div class="form-group col-md-12 col-sm-12">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon" >
                                <p><?php echo ucwords($res->payment_description); ?> </p>                          
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group col-md-12 col-sm-12">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon" >
                            <p><?php echo ucwords($res->payment_term);?></p>                          
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center col-xs-12 mt-15">
                        <div class="col-md-12">
                            ...
                            <a href="<?php echo base_url("manage_sales_order/list_items"); ?>"class="btn green">Back</a>
                        </div>
                    </div>
            </div>
			  </form>
