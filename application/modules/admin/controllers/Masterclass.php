...
class Masterclass extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model("masterclass_model");
    }
    ...
    function listing() {
        ...
        $data['page_title'] = "Master Class";
        $data['page'] = "masterclass/list_items";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Master Class" => base_url('admin/masterclass/listing'));
        _layout($data);
    }

    function list_items_ajax() {
        $res = $this->masterclass_model->list_items_ajax();
    ...
    function add() {
    //  pr($_POST); die;
        $data['page_title'] = "Add Master Class";
        $data['page'] = "masterclass/add";
        $data['title'] = "Add Master Class";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Master Class" => base_url('admin/masterclass/listing'), "Add Master Class" => base_url('admin/masterclass/add'));
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $last_id = $this->masterclass_model->add();
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Master Class Added Successfully. "));
            redirect("admin/masterclass/listing");
        }
        _layout($data);
    }
    ...
    public function edit() {
        ...
        $data['res'] = $this->masterclass_model->viewData($id);
        $this->form_validation->set_rules('video_title', 'Video Ttle', "trim|required");
        $this->form_validation->set_rules('video_url', 'Video Url', "trim|required");
        $this->form_validation->set_rules('description', 'Description', 'trim|required');
        $this->form_validation->set_rules('status', 'Status', 'trim|required');
        ...
        if ($this->form_validation->run() == TRUE) {
            $this->masterclass_model->edit($id);
            ...
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Master Class Updated Successfully. "));
            redirect('admin/masterclass/listing');
        }
   //     $data['roles'] = $this->masterclass_model->get_backendteam();
      //  $data['location'] = get_where("pr_location", array("status" => "1", "is_deleted" => "0"));

        $data['title'] = "Edit Master Class";
        $data['page_title'] = "Edit Master Class";
        $data['page'] = "masterclass/add";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Master Class" => base_url('admin/masterclass/listing'), "Edit Master Class" => "");
        _layout($data);
    }
        ...
        $id = ID_decode($id);
        if (!empty($id)) {
            $data['res'] = $this->masterclass_model->view($id);
            
            //pr($data);die;
            $data['title'] = 'View Master Class';
            $data['page_title'] = 'View Master Class';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Master Class List" => base_url('admin/masterclass/list_items'), "View Master Class" => "");
          
            $data['page'] = "masterclass/view";
            _layout($data);
        }
    }
    ...
    function delete() {
        $id = $_POST['id'];
        $res = $this->masterclass_model->delete($id);
        if ($res['status'] != "false") {
    ...
    function becomecoach() {
        $id = $_POST['id'];
        $res = $this->masterclass_model->assign_coach($id);
        if ($res['status'] != "false") {
    ...
    function becomeuser() {
        $id = $_POST['id'];
        $res = $this->masterclass_model->assign_user($id);
        if ($res['status'] != "false") {
    ...
    public function delete_multiple() {
        ...
        $res = $this->masterclass_model->delete_multiple($id);
        if ($res == "true") {
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "User Deleted Successfully. "));
            echo json_encode($res);
        } else {
    ...
    function upload_portfolio_image($files, $user_id) {
        ...
        if (isset($portfolioimage) && !empty($portfolioimage)) {
            $this->masterclass_model->save_image($portfolioimage, $user_id);
        }
    }
    ...
    function list_items_sales_quote() {
        ...
        $data['quote_age'] = $this->masterclass_model->get_quote_age();

        $data['title'] = "Recieved Sales Quote";
        $data['page_title'] = "Recieved Sales Quote";
        $data['page'] = "list_items_sales_quote";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/masterclass/list_items_sales_quote'));
        _layout($data);
    }

    function list_items_sales_quote_ajax() {
        $res = $this->masterclass_model->list_items_sales_quote_ajax();
    ...
    public function view_sales_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->masterclass_model->view_sales_quote($id);
            $data['res']->rate=$this->masterclass_model->getsales_quote_rate($id);
           // pr($data);
            $data['title'] = 'View Sales Quote';
            $data['page_title'] = 'View Sales Quote';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/masterclass/list_items_sales_quote'), "View Sales Quote" => "");
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    $last_id = $this->masterclass_model->sales_quote_details($id);
                   ...
                   //echo "done";die;
                    ...
                    redirect("admin/masterclass/list_items_sales_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/masterclass/list_items_sales_quote'), "Send Sales Quote" => "");
    ...
    function list_items_service_quote() {
        ...
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/masterclass/list_items_service_quote'));
        _layout($data);
    }

    function list_items_service_quote_ajax() {
        $res = $this->masterclass_model->list_items_service_quote_ajax();
     ...
     public function view_service_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->masterclass_model->view_service_quote($id);
            $data['product']=$this->masterclass_model->view_service_quote_product($id);
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/masterclass/list_items_service_quote'), "View Service Quote" => "");
    ...
    public function send_service_quote($id) {
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($_FILES) {
                    $last_id = $this->masterclass_model->service_quote_details($id);
                    if (isset($_FILES['specifications'])) {
                        $this->upload_specifications($_FILES['specifications']);
                    }
                   //echo "done";die;
                    $this->session->set_flashdata("alert", array("c" => "s", "m" => "Service Quote Details Added Successfully. "));
                    redirect("admin/masterclass/list_items_service_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/masterclass/list_items_service_quote'), "Send Service Quote" => "");
