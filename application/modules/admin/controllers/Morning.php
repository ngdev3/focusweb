...
class Morning extends MY_Controller {
    ...
    function listing() {
        // die;
        $data['title'] = "Morning Focus";
        $data['page_title'] = "Morning Focus";
        $data['page'] = "morning/list_items";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Morning Focus" => base_url('admin/morning/listing'));
        _layout($data);
    }

    function list_items_ajax() {
        $res = $this->morning_model->list_items_ajax();
    ...
    function add() {
    //  pr($_POST); die;
        $data['page_title'] = "Add Morning Focus";
        $data['page'] = "morning/add";
        $data['title'] = "Add Morning Focus";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Morning Focus" => base_url('admin/morning/listing'), "Add Morning Focus" => base_url('admin/morning/add'));
        ...
        $this->form_validation->set_rules('quotation_title', 'Quotation Title', 'trim|required');
        $this->form_validation->set_rules('quotation', 'Quotation', 'trim|required');
        $this->form_validation->set_rules('status', 'Status', 'trim|required');
        if ($this->form_validation->run() == TRUE) {

            $last_id = $this->morning_model->add();
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Morning Added Successfully. "));
            redirect("admin/morning/listing");
        }
        _layout($data);
    }
    ...
    public function edit() {
        ...
        $data['res'] = $this->morning_model->viewData($id);
        $this->form_validation->set_rules('fromdate', 'From Date', "trim|required");
        $this->form_validation->set_rules('todate', 'To Date', "trim|required");
        $this->form_validation->set_rules('set_time', 'Set Time', 'trim|required');
        $this->form_validation->set_rules('quotation_title', 'Quotation Title', 'trim|required');
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Morning Updated Successfully. "));
            redirect('admin/morning/listing');
        }
   //     $data['roles'] = $this->morning_model->get_backendteam();
      //  $data['location'] = get_where("pr_location", array("status" => "1", "is_deleted" => "0"));

        $data['title'] = "Edit Morning Focus";
        $data['page_title'] = "Edit Morning Focus";
        $data['page'] = "morning/add";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Morning Focus" => base_url('admin/morning/listing'), "Edit Morning Focus" => "");
        _layout($data);
    }
        ...
        $id = ID_decode($id);
        if (!empty($id)) {
            $data['res'] = $this->morning_model->view($id);
            
            //pr($data);die;
            $data['title'] = 'View Morning Focus';
            $data['page_title'] = 'View Morning Focus';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Morning Focus List" => base_url('admin/morning/list_items'), "View Morning Focus" => "");
          
            $data['page'] = "morning/view";
            _layout($data);
        }
    }
    ...
    function delete() {
        $id = $_POST['id'];
        $res = $this->morning_model->delete($id);
        if ($res['status'] != "false") {
    ...
    function becomecoach() {
        $id = $_POST['id'];
        $res = $this->morning_model->assign_coach($id);
        if ($res['status'] != "false") {
    ...
    function becomeuser() {
        $id = $_POST['id'];
        $res = $this->morning_model->assign_user($id);
        if ($res['status'] != "false") {
    ...
    public function delete_multiple() {
        ...
        $res = $this->morning_model->delete_multiple($id);
        if ($res == "true") {
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "User Deleted Successfully. "));
            echo json_encode($res);
        } else {
    ...
    function upload_portfolio_image($files, $user_id) {
        ...
        if (isset($portfolioimage) && !empty($portfolioimage)) {
            $this->morning_model->save_image($portfolioimage, $user_id);
        }
    }
    ...
    function list_items_sales_quote() {
        ...
        $data['quote_age'] = $this->morning_model->get_quote_age();

        $data['title'] = "Recieved Sales Quote";
        $data['page_title'] = "Recieved Sales Quote";
        $data['page'] = "list_items_sales_quote";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/morning/list_items_sales_quote'));
        _layout($data);
    }

    function list_items_sales_quote_ajax() {
        $res = $this->morning_model->list_items_sales_quote_ajax();
    ...
    public function view_sales_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->morning_model->view_sales_quote($id);
            $data['res']->rate=$this->morning_model->getsales_quote_rate($id);
           // pr($data);
            $data['title'] = 'View Sales Quote';
            $data['page_title'] = 'View Sales Quote';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/morning/list_items_sales_quote'), "View Sales Quote" => "");
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    $last_id = $this->morning_model->sales_quote_details($id);
                   ...
                   //echo "done";die;
                    ...
                    redirect("admin/morning/list_items_sales_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/morning/list_items_sales_quote'), "Send Sales Quote" => "");
    ...
    function list_items_service_quote() {
        ...
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/morning/list_items_service_quote'));
        _layout($data);
    }

    function list_items_service_quote_ajax() {
        $res = $this->morning_model->list_items_service_quote_ajax();
     ...
     public function view_service_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->morning_model->view_service_quote($id);
            $data['product']=$this->morning_model->view_service_quote_product($id);
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/morning/list_items_service_quote'), "View Service Quote" => "");
    ...
    public function send_service_quote($id) {
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($_FILES) {
                    $last_id = $this->morning_model->service_quote_details($id);
                    if (isset($_FILES['specifications'])) {
                        $this->upload_specifications($_FILES['specifications']);
                    }
                   //echo "done";die;
                    $this->session->set_flashdata("alert", array("c" => "s", "m" => "Service Quote Details Added Successfully. "));
                    redirect("admin/morning/list_items_service_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/morning/list_items_service_quote'), "Send Service Quote" => "");
