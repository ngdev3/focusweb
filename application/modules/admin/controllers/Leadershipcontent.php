...
class Leadershipcontent extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model("leadershipcontent_model");
    }
    ...
    function listing() {
        // die;
        $data['title'] = "Leadership Content Listing";
        $data['page_title'] = "Leadership Content Listing";
        $data['page'] = "leadershipcontent/list_items";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Leadership Content Listing" => base_url('admin/leadershipcontent/listing'));
        _layout($data);
    }

    function list_items_ajax() {
        $res = $this->leadershipcontent_model->list_items_ajax();
    ...
    if($_GET['email'] == 'rajat@tekshapers.com'){
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $last_id = $this->leadershipcontent_model->add();
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Leadership Content Added Successfully. "));
    ...
    public function edit() {
        ...
        if ($this->form_validation->run() == TRUE) {
            $this->leadershipcontent_model->edit($id);
            ...
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Leadership Content Updated Successfully. "));
            redirect('admin/leadershipcontent/listing');
        }
   //     $data['roles'] = $this->leadershipcontent_model->get_backendteam();
      //  $data['location'] = get_where("pr_location", array("status" => "1", "is_deleted" => "0"));

        $data['title'] = "Edit Leadership Content";
        $data['page_title'] = "Edit Leadership Content";
        $data['page'] = "leadershipcontent/add";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Leadership Content Listing" => base_url('admin/leadershipcontent/listing'), "Edit Leadership Content" => "");
        _layout($data);
    }
        ...
        $id = ID_decode($id);
        if (!empty($id)) {
            $data['res'] = $this->leadershipcontent_model->view($id);
            
            //pr($data);die;
            $data['title'] = 'View Leadership Content';
            $data['page_title'] = 'View Leadership Content';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Leadership Content Listing" => base_url('admin/leadershipcontent/list_items'), "View Leadership Content" => "");
          
            $data['page'] = "leadershipcontent/view";
            _layout($data);
        }
    }
    ...
    function delete() {
        $id = $_POST['id'];
        $res = $this->leadershipcontent_model->delete($id);
        if ($res['status'] != "false") {
    ...
    function becomecoach() {
        $id = $_POST['id'];
        $res = $this->leadershipcontent_model->assign_coach($id);
        if ($res['status'] != "false") {
    ...
    function becomeuser() {
        $id = $_POST['id'];
        $res = $this->leadershipcontent_model->assign_user($id);
        if ($res['status'] != "false") {
    ...
    public function delete_multiple() {
        ...
        $res = $this->leadershipcontent_model->delete_multiple($id);
        if ($res == "true") {
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Leadership Content Deleted Successfully. "));
            echo json_encode($res);
        } else {
    ...
    function upload_portfolio_image($files, $user_id) {
        ...
        if (isset($portfolioimage) && !empty($portfolioimage)) {
            $this->leadershipcontent_model->save_image($portfolioimage, $user_id);
        }
    }
    ...
    function list_items_sales_quote() {
        ...
        $data['quote_age'] = $this->leadershipcontent_model->get_quote_age();

        $data['title'] = "Recieved Sales Quote";
        $data['page_title'] = "Recieved Sales Quote";
        $data['page'] = "list_items_sales_quote";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipcontent/list_items_sales_quote'));
        _layout($data);
    }

    function list_items_sales_quote_ajax() {
        $res = $this->leadershipcontent_model->list_items_sales_quote_ajax();
    ...
    public function view_sales_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->leadershipcontent_model->view_sales_quote($id);
            $data['res']->rate=$this->leadershipcontent_model->getsales_quote_rate($id);
           // pr($data);
            $data['title'] = 'View Sales Quote';
            $data['page_title'] = 'View Sales Quote';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipcontent/list_items_sales_quote'), "View Sales Quote" => "");
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    $last_id = $this->leadershipcontent_model->sales_quote_details($id);
                   ...
                   //echo "done";die;
                    ...
                    redirect("admin/leadershipcontent/list_items_sales_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipcontent/list_items_sales_quote'), "Send Sales Quote" => "");
    ...
    function list_items_service_quote() {
        ...
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipcontent/list_items_service_quote'));
        _layout($data);
    }

    function list_items_service_quote_ajax() {
        $res = $this->leadershipcontent_model->list_items_service_quote_ajax();
     ...
     public function view_service_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->leadershipcontent_model->view_service_quote($id);
            $data['product']=$this->leadershipcontent_model->view_service_quote_product($id);
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipcontent/list_items_service_quote'), "View Service Quote" => "");
    ...
    public function send_service_quote($id) {
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($_FILES) {
                    $last_id = $this->leadershipcontent_model->service_quote_details($id);
                    if (isset($_FILES['specifications'])) {
                        $this->upload_specifications($_FILES['specifications']);
                    }
                   //echo "done";die;
                    $this->session->set_flashdata("alert", array("c" => "s", "m" => "Service Quote Details Added Successfully. "));
                    redirect("admin/leadershipcontent/list_items_service_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipcontent/list_items_service_quote'), "Send Service Quote" => "");
