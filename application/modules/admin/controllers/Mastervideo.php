...
class Mastervideo extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model("mastervideo_model");
    }
    ...
    function listing() {
        // die;
        $data['title'] = "Self Mastery video Listing";
        $data['page_title'] = "Self Mastery video Listing";
        $data['page'] = "mastervideo/list_items";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Self Mastery video Listing" => base_url('admin/mastervideo/listing'));
        _layout($data);
    }

    function list_items_ajax() {
        $res = $this->mastervideo_model->list_items_ajax();
    ...
    function add() {
    //  pr($_POST); die;
        $data['page_title'] = "Add Self Mastery video";
        $data['page'] = "mastervideo/add";
        $data['title'] = "Add Self Mastery video";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Self Mastery video Listing" => base_url('admin/mastervideo/listing'), "Add Self Mastery video" => base_url('admin/mastervideo/add'));
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $last_id = $this->mastervideo_model->add();
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Self Mastery video Added Successfully. "));
            redirect("admin/mastervideo/listing");
        }
        _layout($data);
    }
    ...
    public function edit() {
        ...
        $data['res'] = $this->mastervideo_model->viewData($id);
        ...
        if ($this->form_validation->run() == TRUE) {
            $this->mastervideo_model->edit($id);
            ...
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Self Mastery video Updated Successfully. "));
            redirect('admin/mastervideo/listing');
        }
   //     $data['roles'] = $this->mastervideo_model->get_backendteam();
      //  $data['location'] = get_where("pr_location", array("status" => "1", "is_deleted" => "0"));

        $data['title'] = "Edit Self Mastery video";
        $data['page_title'] = "Edit Self Mastery video";
        $data['page'] = "mastervideo/add";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Self Mastery video Listing" => base_url('admin/mastervideo/listing'), "Edit Self Mastery video" => "");
        _layout($data);
    }
        ...
        $id = ID_decode($id);
        if (!empty($id)) {
            $data['res'] = $this->mastervideo_model->view($id);
            
            //pr($data);die;
            $data['title'] = 'View Self Mastery video';
            $data['page_title'] = 'View Self Mastery video';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Self Mastery video Listing" => base_url('admin/mastervideo/list_items'), "View Self Mastery video" => "");
          
            $data['page'] = "mastervideo/view";
            _layout($data);
        }
    }
    ...
    function delete() {
        $id = $_POST['id'];
        $res = $this->mastervideo_model->delete($id);
        if ($res['status'] != "false") {
    ...
    function becomecoach() {
        $id = $_POST['id'];
        $res = $this->mastervideo_model->assign_coach($id);
        if ($res['status'] != "false") {
    ...
    function becomeuser() {
        $id = $_POST['id'];
        $res = $this->mastervideo_model->assign_user($id);
        if ($res['status'] != "false") {
    ...
    public function delete_multiple() {
        ...
        $res = $this->mastervideo_model->delete_multiple($id);
        if ($res == "true") {
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Self Mastery video Deleted Successfully. "));
            echo json_encode($res);
        } else {
    ...
    function upload_portfolio_image($files, $user_id) {
        ...
        if (isset($portfolioimage) && !empty($portfolioimage)) {
            $this->mastervideo_model->save_image($portfolioimage, $user_id);
        }
    }
    ...
    function list_items_sales_quote() {
        ...
        $data['quote_age'] = $this->mastervideo_model->get_quote_age();

        $data['title'] = "Recieved Sales Quote";
        $data['page_title'] = "Recieved Sales Quote";
        $data['page'] = "list_items_sales_quote";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/mastervideo/list_items_sales_quote'));
        _layout($data);
    }

    function list_items_sales_quote_ajax() {
        $res = $this->mastervideo_model->list_items_sales_quote_ajax();
    ...
    public function view_sales_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->mastervideo_model->view_sales_quote($id);
            $data['res']->rate=$this->mastervideo_model->getsales_quote_rate($id);
           // pr($data);
            $data['title'] = 'View Sales Quote';
            $data['page_title'] = 'View Sales Quote';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/mastervideo/list_items_sales_quote'), "View Sales Quote" => "");
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    $last_id = $this->mastervideo_model->sales_quote_details($id);
                   ...
                   //echo "done";die;
                    ...
                    redirect("admin/mastervideo/list_items_sales_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/mastervideo/list_items_sales_quote'), "Send Sales Quote" => "");
    ...
    function list_items_service_quote() {
        ...
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/mastervideo/list_items_service_quote'));
        _layout($data);
    }

    function list_items_service_quote_ajax() {
        $res = $this->mastervideo_model->list_items_service_quote_ajax();
     ...
     public function view_service_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->mastervideo_model->view_service_quote($id);
            $data['product']=$this->mastervideo_model->view_service_quote_product($id);
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/mastervideo/list_items_service_quote'), "View Service Quote" => "");
    ...
    public function send_service_quote($id) {
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($_FILES) {
                    $last_id = $this->mastervideo_model->service_quote_details($id);
                    if (isset($_FILES['specifications'])) {
                        $this->upload_specifications($_FILES['specifications']);
                    }
                   //echo "done";die;
                    $this->session->set_flashdata("alert", array("c" => "s", "m" => "Service Quote Details Added Successfully. "));
                    redirect("admin/mastervideo/list_items_service_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/mastervideo/list_items_service_quote'), "Send Service Quote" => "");
