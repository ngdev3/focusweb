...
class Leadershipvideo extends MY_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model("leadershipvideo_model");
    }
    ...
    function listing() {
        // die;
        $data['title'] = "Business Leadership video Listing";
        $data['page_title'] = "Business Leadership video Listing";
        $data['page'] = "leadershipvideo/list_items";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Business Leadership video Listing" => base_url('admin/leadershipvideo/listing'));
        _layout($data);
    }

    function list_items_ajax() {
        $res = $this->leadershipvideo_model->list_items_ajax();
    ...
    function add() {
    //  pr($_POST); die;
        $data['page_title'] = "Add Business Leadership video";
        $data['page'] = "leadershipvideo/add";
        $data['title'] = "Add Business Leadership video";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Business Leadership video Listing" => base_url('admin/leadershipvideo/listing'), "Add Business Leadership video" => base_url('admin/leadershipvideo/add'));

        $this->form_validation->set_rules('video_title', 'video Ttle', "trim|required");
        $this->form_validation->set_rules('description', 'Description', 'trim|required');
        $this->form_validation->set_rules('status', 'Status', 'trim|required');
        if ($this->form_validation->run() == TRUE) {

            $last_id = $this->leadershipvideo_model->add();
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Business Leadership video Added Successfully. "));
            redirect("admin/leadershipvideo/listing");
        }
        _layout($data);
    }
    ...
    public function edit() {
        ...
        $data['res'] = $this->leadershipvideo_model->viewData($id);
        $this->form_validation->set_rules('video_title', 'Video Ttle', "trim|required");
        ...
        if ($this->form_validation->run() == TRUE) {
            $this->leadershipvideo_model->edit($id);
            ...
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Business Leadership video Updated Successfully. "));
            redirect('admin/leadershipvideo/listing');
        }
   //     $data['roles'] = $this->leadershipvideo_model->get_backendteam();
      //  $data['location'] = get_where("pr_location", array("status" => "1", "is_deleted" => "0"));

        $data['title'] = "Edit Business Leadership video";
        $data['page_title'] = "Edit Business Leadership video";
        $data['page'] = "leadershipvideo/add";
        $data['breadcrumb'] = array("Dashboard" => base_url(), "Business Leadership video Listing" => base_url('admin/leadershipvideo/listing'), "Edit Business Leadership video" => "");
        _layout($data);
    }
        ...
        $id = ID_decode($id);
        if (!empty($id)) {
            $data['res'] = $this->leadershipvideo_model->view($id);
            
            //pr($data);die;
            $data['title'] = 'View Business Leadership video';
            $data['page_title'] = 'View Business Leadership video';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Business Leadership video Listing" => base_url('admin/leadershipvideo/list_items'), "View Leadership video" => "");
          
            $data['page'] = "leadershipvideo/view";
            _layout($data);
        }
    }
    ...
    function delete() {
        $id = $_POST['id'];
        $res = $this->leadershipvideo_model->delete($id);
        if ($res['status'] != "false") {
    ...
    function becomecoach() {
        $id = $_POST['id'];
        $res = $this->leadershipvideo_model->assign_coach($id);
        if ($res['status'] != "false") {
    ...
    function becomeuser() {
        $id = $_POST['id'];
        $res = $this->leadershipvideo_model->assign_user($id);
        if ($res['status'] != "false") {
    ...
    public function delete_multiple() {
        ...
        $res = $this->leadershipvideo_model->delete_multiple($id);
        if ($res == "true") {
            $this->session->set_flashdata("alert", array("c" => "s", "m" => "Business Leadership video Deleted Successfully. "));
            echo json_encode($res);
        } else {
    ...
    function upload_portfolio_image($files, $user_id) {
        ...
        if (isset($portfolioimage) && !empty($portfolioimage)) {
            $this->leadershipvideo_model->save_image($portfolioimage, $user_id);
        }
    }
    ...
    function list_items_sales_quote() {
        ...
        $data['quote_age'] = $this->leadershipvideo_model->get_quote_age();

        $data['title'] = "Recieved Sales Quote";
        $data['page_title'] = "Recieved Sales Quote";
        $data['page'] = "list_items_sales_quote";
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipvideo/list_items_sales_quote'));
        _layout($data);
    }

    function list_items_sales_quote_ajax() {
        $res = $this->leadershipvideo_model->list_items_sales_quote_ajax();
    ...
    public function view_sales_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->leadershipvideo_model->view_sales_quote($id);
            $data['res']->rate=$this->leadershipvideo_model->getsales_quote_rate($id);
           // pr($data);
            $data['title'] = 'View Sales Quote';
            $data['page_title'] = 'View Sales Quote';
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipvideo/list_items_sales_quote'), "View Sales Quote" => "");
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($this->form_validation->run() == TRUE) {
                    ...
                    $last_id = $this->leadershipvideo_model->sales_quote_details($id);
                   ...
                   //echo "done";die;
                    ...
                    redirect("admin/leadershipvideo/list_items_sales_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Sales Quote" => base_url('admin/leadershipvideo/list_items_sales_quote'), "Send Sales Quote" => "");
    ...
    function list_items_service_quote() {
        ...
        $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipvideo/list_items_service_quote'));
        _layout($data);
    }

    function list_items_service_quote_ajax() {
        $res = $this->leadershipvideo_model->list_items_service_quote_ajax();
     ...
     public function view_service_quote($id) {
        ...
        if (!empty($id)) {
            $data['res'] = $this->leadershipvideo_model->view_service_quote($id);
            $data['product']=$this->leadershipvideo_model->view_service_quote_product($id);
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipvideo/list_items_service_quote'), "View Service Quote" => "");
    ...
    public function send_service_quote($id) {
        ...
        if (!empty($id)) {
            ...
            if(isPostBack()){
                ...
                if($_FILES) {
                    $last_id = $this->leadershipvideo_model->service_quote_details($id);
                    if (isset($_FILES['specifications'])) {
                        $this->upload_specifications($_FILES['specifications']);
                    }
                   //echo "done";die;
                    $this->session->set_flashdata("alert", array("c" => "s", "m" => "Service Quote Details Added Successfully. "));
                    redirect("admin/leadershipvideo/list_items_service_quote");
                }
            ...
            $data['breadcrumb'] = array("Dashboard" => base_url('dashboard/'), "Recieved Service Quote" => base_url('admin/leadershipvideo/list_items_service_quote'), "Send Service Quote" => "");
