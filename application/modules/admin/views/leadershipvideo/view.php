        ...
        <div class="portlet-title">
            ...
            <div class="portlet-body form add_prodcut_form">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group col-md-12 col-sm-12">
                        <label for="inputEmail12" class="col-md-3 control-label">Video Url :</label>
                        <div class="col-md-9">
                            <div class="input-icon" >
                                <p><?php echo ucwords($res->url); ?></p>                          
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-md-12 col-sm-12">
                    ...
                    <div class="form-group text-center col-xs-12 mt-15">
                        <div class="col-md-12">
                            <a href="<?php echo base_url("admin/leadershipvideo/listing"); ?>"class="btn green">Back</a>
                        </div>
                    </div>
                </form>
