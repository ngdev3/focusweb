                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="btn-group btn_grp_list">
                                                        <a href='<?php echo base_url("admin/mastervideo/add"); ?>' id="sample_editable_1_new" class="btn sbold green"> Add New
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
          ...
          "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]],// change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>admin/mastervideo/list_items_ajax?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
    ...
    $(document).ready(function() {
        ...
        jConfirm('Are you sure?', 'Confirmation Dialog', function(r) {
              ...
              if(r==true)
                {
                    $.ajax({
                        url:"<?php echo base_url('admin/mastervideo/delete'); ?>",
                        type:"POST",
                        data:{id:id},
                        success:function(){
                            //table.draw();
                            window.location.href="<?php echo base_url('admin/mastervideo/listing'); ?>";
                        },
                        error:function(){
        ...
        jConfirm('Are you sure convert into Coach ?', 'Confirmation Dialog', function(r) {
              ...
              if(r==true)
                {
                    $.ajax({
                        url:"<?php echo base_url('admin/mastervideo/becomecoach'); ?>",
                        type:"POST",
                        data:{id:id},
                        success:function(){
                            //table.draw();
        ...
        jConfirm('Are you sure convert into User ?', 'Confirmation Dialog', function(r) {
              ...
              if(r==true)
                {
                    $.ajax({
                        url:"<?php echo base_url('admin/mastervideo/becomeuser'); ?>",
                        type:"POST",
                        data:{id:id},
                        success:function(){
                            //table.draw();
  ...
  if(all_id.length>=1){
	...
	if(s==true)
             ...
             $.ajax({
                    ...
                    type:"POST",
                    url:"<?php echo base_url("admin/mastervideo/delete_multiple") ?>",
                    data:{ids:all_id},
	                success:function(data){
                           window.location.href = "<?= base_url() ?>admin/mastervideo/listing";
                      }
            });
		}
	  }); 
