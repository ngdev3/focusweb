                ...
                <form role="form" id="add_form" method="post" enctype="multipart/form-data">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" class="form-control" id="quotation_title" name="quotation_title"  value="<?php echo set_value("quotation_title", @$res->quotation_title); ?>" >
                                    <div class="text-danger"><?php echo form_error("quotation_title"); ?></div>

                                    <label for="quotation_title">Quotation Title<span class="red_sign">*</span></label>

                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="textarea" class="form-control" id="quotation" name="quotation"  value="<?php echo set_value("quotation", @$res->quotation); ?>" >
                                    <div class="text-danger"><?php echo form_error("quotation"); ?></div>

                                    <label for="quotation">Quotation<span class="red_sign">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-12 text-center">
                            <div class="form-actions noborder">
                                ...
                                <a href="<?php echo base_url("admin/morning/listing"); ?>"class="btn default">Cancel</a>
                            </div>
                        </div>
                    </div>
                </form>
