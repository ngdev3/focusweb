...
<div class="col-md-12 col-xs-12">
                   ...
                   <br>
                            <form class="form-horizontal form-material" id="add_form" method="post" enctype="multipart/form-data">
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input textarea rows="4" cols="50" placeholder="Description" name="description"  class="form-control form-control-line"> </div>
