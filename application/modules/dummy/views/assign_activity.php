                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <label for="cordinator_id"> Cordinator</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <label for="salesperson_id"> Select Sales Person</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" class="form-control" id="location" name="location"  value="<?php echo set_value("location", @$res_lead->location); ?>" readonly="">
                           ...
                           <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <label for="form_control_3">Status</label>
                        ...
                        messages:
                                {
                                    ...
                                    salesperson_id:
                                     ...
                                     activity:
                                            ...
                                            meeting_date:
                                            {
                                               required: "<br><br>Please Enter Metting Date!"  
                                            },
