                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <div class="input-icon" >
                                        <p><?php echo $res_lead->dymic_lead_id; ?></p>                          
                                    </div>
                                </div>
                            </div>  
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    ...
                                    <label for="salesperson_id"> Select Sales Person<span class="red_sign">*</span></label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group form-md-line-input form-md-floating-label">
                                    <input type="text" class="form-control" id="location" name="location"  value="<?php if((@$res_lead->location && @$res_lead->address) || @$res_lead->location ){echo set_value("location", @$res_lead->location);}else{echo set_value("location", @$res_lead->address);} ?>" readonly="">
