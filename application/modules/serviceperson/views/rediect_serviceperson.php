<style>
    ...
    .form-horizontal .control-label{text-align:left!important;font-weight:600;}
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        <label for="inputEmail12" class="col-md-4 control-label">Manager Name:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group col-md-6 col-sm-6">
                        <label for="inputEmail12" class="col-md-4 control-label">Coordinator Name :</label>
                        <div class="col-md-8">
                            <div class="input-icon" >
                                <p><?php echo ucwords($coordinator->fname.' '.$coordinator->lname); ?></p>                          
                            </div>
                        </div>
                    </div>
                                              </form>
    ...
    $(document).ready(function(){             
        ...
        table.dataTable({
          ...
          "lengthMenu": [[5,10,50, 100, 200, -1],[5,10, 50,100, 200, "All"]],// change perpage values here
            ...
            "ajax":{
                url :"<?php echo base_url();?>serviceperson/redirect_serviceperson_ajax/<?php echo $this->uri->segment(3);?>?<?php echo $_SERVER["QUERY_STRING"]; ?>", // json datasource
                type: "post",                              
				error: function(data){
					alert(data);
                    //console.log(data);
    ...
    $(document).ready(function() {
        ...
        jConfirm('Are you sure?', 'Confirmation Dialog', function(r) {
              ...
              if(r==true)
                {
                    $.ajax({
                        url:"<?php echo base_url('manager/delete'); ?>",
                        type:"POST",
                        data:{id:id},
                        success:function(){
                            //table.draw();
                            window.location.href="<?php echo base_url('manager/list_items'); ?>";
                        },
                        error:function(){
  ...
  if(all_id.length>=1){
	...
	if(s==true)
             ...
             $.ajax({
                    ...
                    type:"POST",
                    url:"<?php echo base_url("manager/delete_multiple") ?>",
                    data:{ids:all_id},
	                success:function(data){
                           window.location.href = "<?= base_url() ?>manager/list_items";
                      }
            });
		}
	  }); 
