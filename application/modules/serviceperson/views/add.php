          ...
          $(selected).val('');
            ...
            <script>
                $(document).on('change', '#manager_id', function() {
                   ...
                   $.ajax({
                               type :"POST",
                                url : '<?php echo base_url(); ?>serviceperson/getservicecordinator',
...
<!--------------------------------serviceperson value retain for validation false starts---->
<script>

$(function() {

    var manager_id = "<?php echo $_POST['manager_id']; ?>";
    var cordinator_id =  "<?php echo $_POST['cordinator_id']; ?>";
    if(manager_id==""){
       manager_id = "<?php echo $res->manager_id; ?>";  
    }
    
    if(cordinator_id==""){
        cordinator_id = "<?php echo $res->cordinator_id; ?>";  
    }
    $.ajax({
                               type :"POST",
                                url : '<?php echo base_url(); ?>serviceperson/getservicecordinator',
                      ...
                      success: function(data) {
                      $("#cordinator_id").html(data);
                      $("#cordinator_id").val(cordinator_id);
                }
            });
});

</script>
<!--------------------------------serviceperson value retain for validation false ends---->
