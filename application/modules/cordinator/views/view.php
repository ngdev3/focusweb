        ...
        <div class="portlet-title">
            ...
            <div class="portlet-body form add_prodcut_form">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <?php } ?>
                     <div class="form-group col-md-12 col-sm-12">
                        <label for="inputEmail12" class="col-md-3 control-label">Coordinator Type:</label>
                        <div class="col-md-9">
                            <div class="input-icon" >
                                <p> <?php echo ucwords($res->role_name); ?></p>                          
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group col-md-12 col-sm-12">
                        ...
                        <div class="col-md-9">
                            <div class="input-icon" >
                                <p><img alt="" class="img-circle" src="<?php echo base_url(); ?>uploads/profile_image/<?php echo @$res->profile_image;?>" height="80"></p>                          
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group text-center col-xs-12 mt-15">
                        <div class="col-md-12">
                            <a href="<?php echo base_url("cordinator/list_items"); ?>"class="btn green">Back</a>
                        </div>
                    </div>
                </form>
